...
FONT_SRCS = $(addprefix u8glib/fntsrc/,u8g_font_6x10.c)
FONT_OBJS = $(addprefix out/,$(patsubst %.c,%.o,${FONT_SRCS}))
U8GLIB_SRCS = $(addprefix u8glib/csrc/,u8g_dev_ili9225_176x220.c u8g_com_atmega_sw_spi.c u8g_com_api.c u8g_pb.c u8g_pb8h8.c u8g_page.c u8g_delay.c u8g_com_io.c u8g_state.c u8g_ll_api.c u8g_font.c u8g_clip.c)
